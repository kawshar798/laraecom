                    ...
                    <div class="js-slide bg-img-hero-center">
                        <div class="row min-height-420 py-7 py-md-0">
                            ...
                            <div class="col-xl-5 col-6  d-flex align-items-center"
                                ...
                                <img class="img-fluid" src="{{asset('public/frontend/')}}/assets/img//416X420/img1.png" alt="Image Description">
                            </div>
                        </div>
                    </div>
                    <div class="js-slide bg-img-hero-center" data-animation-delay="0">
                        <div class="row min-height-420 py-7 py-md-0">
                            ...
                            <div class="col-xl-5 col-6  d-flex align-items-center"
                                 data-scs-animation-in="fadeInUp"
                                 data-scs-animation-delay="500">
                                <img class="img-fluid" src="{{asset('public/frontend/')}}/assets/img//416X420/img2.png" alt="Image Description">
                            </div>
                        </div>
                    </div>
                    <div class="js-slide bg-img-hero-center" data-animation-delay="0">
                        <div class="row min-height-420 py-7 py-md-0">
                            ...
                            <div class="col-xl-5 col-6  d-flex align-items-center"
                                 ...
                                 data-scs-animation-delay="500">
                                <img class="img-fluid" src="{{asset('public/frontend/')}}/assets/img//416X420/img3.png" alt="Image Description">
                            </div>
                        </div>
                    </div>
                </div>
