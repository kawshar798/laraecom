        ...
        <div class="row">
                ...
                <div class="widget-column">
                    ...
                    <ul class="list-unstyled products-group">
                        <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                            <div class="col-auto">
                                <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center"><img class="img-fluid" src="{{asset('public/frontend/')}}/assets/img//75X75/img1.jpg" alt="Image Description"></a>
                            </div>
                        ...
                        <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                            <div class="col-auto">
                                <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center"><img class="img-fluid" src="{{asset('public/frontend/')}}/assets/img//75X75/img2.jpg" alt="Image Description"></a>
                            </div>
                            <div class="col pl-4 d-flex flex-column">
                        ...
                        <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                            <div class="col-auto">
                                <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center"><img class="img-fluid" src="{{asset('public/frontend/')}}/assets/img//75X75/img3.jpg" alt="Image Description"></a>
                            </div>
                            <div class="col pl-4 d-flex flex-column">
            ...
            <div class="col-wd-3 col-lg-4">
                ...
                <ul class="list-unstyled products-group">
                    <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                        <div class="col-auto">
                            <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center"><img class="img-fluid" src="{{asset('public/frontend/')}}/assets/img//75X75/img4.jpg" alt="Image Description"></a>
                        </div>
                        <div class="col pl-4 d-flex flex-column">
                    ...
                    <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                        <div class="col-auto">
                            <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center"><img class="img-fluid" src="{{asset('public/frontend/')}}/assets/img//75X75/img5.jpg" alt="Image Description"></a>
                        </div>
                        <div class="col pl-4 d-flex flex-column">
                    ...
                    <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                        <div class="col-auto">
                            <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center"><img class="img-fluid" src="{{asset('public/frontend/')}}/assets/img//75X75/img6.jpg" alt="Image Description"></a>
                        </div>
                        <div class="col pl-4 d-flex flex-column">
            ...
            <div class="col-wd-3 col-lg-4">
                ...
                <ul class="list-unstyled products-group">
                    <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                        <div class="col-auto">
                            <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center"><img class="img-fluid" src="{{asset('public/frontend/')}}/assets/img//75X75/img7.jpg" alt="Image Description"></a>
                        </div>
                        <div class="col pl-4 d-flex flex-column">
                    ...
                    <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                        <div class="col-auto">
                            <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center"><img class="img-fluid" src="{{asset('public/frontend/')}}/assets/img//75X75/img8.jpg" alt="Image Description"></a>
                        </div>
                        <div class="col pl-4 d-flex flex-column">
                    ...
                    <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                        <div class="col-auto">
                            <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center"><img class="img-fluid" src="{{asset('public/frontend/')}}/assets/img//75X75/img9.jpg" alt="Image Description"></a>
                        </div>
                        <div class="col pl-4 d-flex flex-column">
            ...
            <div class="col-wd-3 d-none d-wd-block">
                <a href="../shop/shop.html" class="d-block"><img class="img-fluid" src="{{asset('public/frontend/')}}/assets/img//330X360/img1.jpg" alt="Image Description"></a>
            </div>
        </div>
    </div>
            ...
            <div class="flex-center-between d-block d-md-flex">
                ...
                <div class="text-md-right">
                            <span class="d-inline-block bg-white border rounded p-1">
                                <img class="max-width-5" src="{{asset('public/frontend/')}}/assets/img//100X60/img1.jpg" alt="Image Description">
                            </span>
                    <span class="d-inline-block bg-white border rounded p-1">
                                <img class="max-width-5" src="{{asset('public/frontend/')}}/assets/img//100X60/img2.jpg" alt="Image Description">
                            </span>
                    <span class="d-inline-block bg-white border rounded p-1">
                                <img class="max-width-5" src="{{asset('public/frontend/')}}/assets/img//100X60/img3.jpg" alt="Image Description">
                            </span>
                    <span class="d-inline-block bg-white border rounded p-1">
                                <img class="max-width-5" src="{{asset('public/frontend/')}}/assets/img//100X60/img4.jpg" alt="Image Description">
                            </span>
                    <span class="d-inline-block bg-white border rounded p-1">
                                <img class="max-width-5" src="{{asset('public/frontend/')}}/assets/img//100X60/img5.jpg" alt="Image Description">
                            </span>
                </div>
            </div>
        </div>
