                                            ...
                                            <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
                                                <ul class="navbar-nav u-header__navbar-nav">
                                                    ...
                                                    <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                        data-event="hover"
                                                        data-position="left">
                                                        <a id="basicMegaMenu3" class="nav-link u-header__nav-link u-header__nav-link-toggle" href="javascript:;" aria-haspopup="true" aria-expanded="false">{{$category->name}}</a>

                                                        <!-- Nav Item - Mega Menu -->
                                                        <div class="hs-mega-menu vmm-tfw u-header__sub-menu" aria-labelledby="basicMegaMenu3">
                                                            <div class="vmm-bg">
                                                                <img class="img-fluid" src="https://transvelo.github.io/electro-html/2.0/assets/img/500X400/img1.png" alt="Image Description">
                                                            </div>
...
@endphp 
                                                                ...
                                                                <div class="col mb-3 mb-sm-0">
                                                                    ...
                                                                    <ul class="u-header__sub-menu-nav-group mb-3">
                                                                        ...
                                                                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">{{$sub_cat->name}}</a></li>
                                                                        @endforeach
