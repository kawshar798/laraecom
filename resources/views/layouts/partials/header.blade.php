                                        ...
                                        <ul class="list-unstyled px-3 pt-3">
                                                ...
                                                <div class="">
                                                    <ul class="list-unstyled row mx-n2">
                                                        <li class="px-2 col-auto">
                                                            <img class="img-fluid" src="{{asset('public/frontend/')}}/assets/img//75X75/img1.jpg" alt="Image Description">
                                                        </li>
                                                        <li class="px-2 col">
                                            ...
                                            <li class="border-bottom pb-3 mb-3">
                                                <div class="">
                                                    <ul class="list-unstyled row mx-n2">
                                                        <li class="px-2 col-auto">
                                                            <img class="img-fluid" src="{{asset('public/frontend/')}}/assets/img//75X75/img2.jpg" alt="Image Description">
                                                        </li>
                                                        <li class="px-2 col">
                                                ...
                                                <ul class="navbar-nav u-header__navbar-nav">
                                                    ...
                                                    <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                        ...
                                                        <div class="hs-mega-menu vmm-tfw u-header__sub-menu" aria-labelledby="basicMegaMenu">
                                                            <div class="vmm-bg">
                                                                <img class="img-fluid" src="{{asset('public/frontend/assets/img/500X400/img1.png')}}" alt="Image Description">
                                                            </div>
                                                    ...
                                                    <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                        ...
                                                        <div class="hs-mega-menu vmm-tfw u-header__sub-menu" aria-labelledby="basicMegaMenu1">
                                                            <div class="vmm-bg">
                                                                <img class="img-fluid" src="{{asset('public/frontend/assets/img/500X400/img4.png')}} " alt="Image Description">
                                                            </div>
                                                            <div class="row u-header__mega-menu-wrapper">
                                                                <div class="col mb-3 mb-sm-0">
                                                    ...
                                                    <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                        ...
                                                        <div class="hs-mega-menu vmm-tfw u-header__sub-menu vmm-bg-extended" aria-labelledby="basicMegaMenu2">
                                                            <div class="vmm-bg">
                                                                <img class="img-fluid" src="{{asset('public/frontend/assets/img/500X400/img3.png')}} " alt="Image Description">
                                                            </div>
                                                            <div class="row u-header__mega-menu-wrapper">
                                                                <div class="col mb-3 mb-sm-0">
                                                    ...
                                                    <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                        ...
                                                        <div class="hs-mega-menu vmm-tfw u-header__sub-menu" aria-labelledby="basicMegaMenu3">
                                                            <div class="vmm-bg">
                                                                <img class="img-fluid" src="{{asset('public/frontend/')}}/assets/img//500X400/img2.png" alt="Image Description">
                                                            </div>
                                                            <div class="row u-header__mega-menu-wrapper">
                                                                <div class="col mb-3 mb-sm-0">
                                                    ...
                                                    <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                        ...
                                                        <div class="hs-mega-menu vmm-tfw u-header__sub-menu" aria-labelledby="basicMegaMenu4">
                                                            <div class="vmm-bg">
                                                                <img class="img-fluid" src="{{asset('public/frontend/')}}/assets/img//500X400/img5.png" alt="Image Description">
                                                            </div>
                                                            <div class="row u-header__mega-menu-wrapper">
                                                                <div class="col mb-3 mb-sm-0">
                                                                    <span class="u-header__sub-menu-title">Audio & Video</span>
                                                    ...
                                                    <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                        ...
                                                        <div class="hs-mega-menu vmm-tfw u-header__sub-menu" aria-labelledby="basicMegaMenu5">
                                                            <div class="vmm-bg">
                                                                <img class="img-fluid" src="{{asset('public/frontend/')}}/assets/img//500X400/img6.png" alt="Image Description">
                                                            </div>
                                                            <div class="row u-header__mega-menu-wrapper">
                                                                <div class="col mb-3 mb-sm-0">
                                                    ...
                                                    <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                        ...
                                                        <div class="hs-mega-menu vmm-tfw u-header__sub-menu" aria-labelledby="basicMegaMenu3">
                                                            <div class="vmm-bg">
                                                                <img class="img-fluid" src="{{asset('public/frontend/')}}/assets/img//500X400/img7.png" alt="Image Description">
                                                            </div>
                                                            <div class="row u-header__mega-menu-wrapper">
                                                                <div class="col mb-3 mb-sm-0">
