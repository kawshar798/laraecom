                ...
                <div class="col-lg-5 col-md-6">
                    ...
                    <div class="product-details-left">
                        <div class="product-details-images slider-navigation-1">
                            <div class="lg-image">
                                <a class="popup-img venobox vbox-item" href="{{asset($product->image_one)}}" data-gall="myGallery">
                                    <img src="{{asset($product->image_one)}}" alt="product image">
                                </a>
                            </div>
                            <div class="lg-image">
                                <a class="popup-img venobox vbox-item" href="{{asset($product->image_two)}}" data-gall="myGallery">
                                    <img src="{{asset($product->image_two)}}" alt="product image">
                                </a>
                            </div>
                            <div class="lg-image">
                                <a class="popup-img venobox vbox-item" href="{{asset($product->image_three)}}" data-gall="myGallery">
                                    <img src="{{asset($product->image_three)}}" alt="product image">
                                </a>
                            </div>
                    ...
                    <div class="product-details-view-content pt-60">
                        <div class="product-info">
                            ...
                            <div class="d-flex align-items-center ">
                                <a href="#">{{isset($product->category->name)?$product->category->name:''}} </a> @if(isset($product->subcategory->name))  <i class="fa fa-angle-right"></i>  <a href="#"> {{isset($product->subcategory->name)?$product->subcategory->name:''}}</a>@endif
                            </div>
            ...
            <div class="tab-content">
                ...
                <div id="product-details" class="tab-pane" role="tabpanel">
                    <div class="product-details-manufacturer">
                        ...
                        <p><span>Category : </span><a href="{{$product->category_id}}">{{isset($product->category->name)?$product->category->name:''}}</a></p>
                        @if(isset($product->subcategory->name))
                            <p><span>Sub Category : </span><a href="{{$product->sub_category_id}}">{{$product->subcategory->name}}</a></p>
                            @endif

                        <p><span>Brand : </span><a href="{{$product->brand_id}}"{{isset($product->brand->name)?$product->brand->name:''}}></a></p>
                        <p><span>Stock Product  : </span>{{$product->quantity}}</p>
                    </div>
                </div>
